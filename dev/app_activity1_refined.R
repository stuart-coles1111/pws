...
server <- function(input, output, session){
    ...
    output$stats_table <- render_gt({
        ...
        # -------------------------------------------------
        # Add uploaded columns if uploaded data exists
        # -------------------------------------------------
        ...
        # -------------------------------------------------
        # Uploaded formatting only if uploaded exists
        # -------------------------------------------------
    ...
    output$heads_plot <- renderPlot({
        ...
        if(input$compare_theoretical){
            ...
            theory_df <- theoretical_heads_df()
