...
#'
#'
activity7_smarties_q1 <- function(data_df, nrep = 10000){
    ...
    ggplot2::ggplot(sd_sd_df, ggplot2::aes(sd_sd)) +
        ggplot2::geom_histogram(fill="lightblue", colour="black", binwidth=0.05, ggplot2::aes(y = ggplot2::after_stat(density))) +
