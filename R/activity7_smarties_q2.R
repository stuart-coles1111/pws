...
#'
#'
activity7_smarties_q2 <- function(data_df, nrep = 10000){
    ssd <- c()
    ...
    ggplot2::ggplot(ssd_df, ggplot2::aes(ssd)) +
        ggplot2::geom_histogram(fill="lightblue", colour="black", binwidth=2,  ggplot2::aes(y =  ggplot2::after_stat(density))) +
